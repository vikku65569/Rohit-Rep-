...
BOT_TOKEN = environ.get('BOT_TOKEN', "7543898375:AAFW-oXCMD_1ziFkfFiEDJgvZ9_weoce1nY")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002066309708').split()]  # For Multiple Id Use One Space Between Each.
